 ...
 * @date 12.II.03
 */
public class SMapAsdu extends MapAsdu
{
	public boolean class1 	= false;
	public boolean class2 	= false;
	public boolean gi	= false;
	public boolean write	= false;
	public SMapAsdu(AsduKey key, MapSingleValue[] value, boolean class1, boolean class2, boolean gi)
	{
		super(key,value);
		this.class1	= class1;
		this.class2	= class2;
	...
	public SMapAsdu(AsduKey key, boolean class1, boolean class2, boolean gi)
	{
		this(key,null,class1,class2,gi);
	}
}
